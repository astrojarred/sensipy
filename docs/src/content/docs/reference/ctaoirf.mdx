...
| `version`       | `str`  | `"prod5-v0.1"`, `"prod5-v0.2"`, `"prod3b-v2"` |
| `modified`      | `bool` | Use modified IRFs (v0.2 only)                 |
| `nsb`           | `bool` | Include NSB effects (v0.2 only)               |
...
- [Setup Guide](/getting_started/setup) - IRF installation and configuration
- [Loading IRFs Tutorial](/tutorials/loading_irfs) - Detailed tutorial
- [Sensitivity API](/reference/sensitivity) - Using IRFs for sensitivity calculations
