...
Property that returns source metadata dictionary.

```python
meta = source.metadata
print(meta['id'], meta['dist'], meta['eiso'])
```
...
See [Spectral Models](/getting_started/spectral_models) for format details.

## Related

- [Spectral Models Guide](/getting_started/spectral_models)
- [Basic Workflow Tutorial](/tutorials/basic_workflow) -[Simulating Observations Tutorial](/tutorials/simulating_observations)
