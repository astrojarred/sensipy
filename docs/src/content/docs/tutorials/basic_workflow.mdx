...
- [IRFs Guide](/getting_started/irfs) - Setting up and downloading IRFs
- [Sensitivity Calculations](/getting_started/sensitivity) - Comprehensive guide to sensitivity calculations
- [Exposure Time Calculations](/getting_started/exposure) - Detailed exposure calculation methods
- [Spectral Models](/getting_started/spectral_models) - Format and loading spectral models
- [EBL Models](/getting_started/ebl_models) - Understanding EBL absorption
