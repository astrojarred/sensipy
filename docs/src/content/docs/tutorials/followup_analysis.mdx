...
<Tabs>
  <TabItem label="Simple Scan">
    ...
    event_ids = lookup_df['event_id'].unique()[:100]  # First 100
...
event_ids = lookup_df['event_id'].unique()[:50]
...
lookup_df_filtered = lookup_df[
    (lookup_df['irf_site'] == 'south') &
    (lookup_df['irf_zenith'] == 20) &
    (lookup_df['irf_ebl_model'] == 'franceschini')
].copy()
