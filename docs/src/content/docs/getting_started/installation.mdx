...
<Aside type="caution" title="Don't skip setup!">
    After installing sensipy, make sure to complete the [setup steps](/getting_started/setup) to download the required instrument response files (IRFs).
</Aside>
