---
title: Overview
description: Overview of sensipy - A Python toolkit to simulate instrument sensitivity and plan follow-up observations of time-variable astrophysical sources with gamma-ray observatories.
---
...
<Aside type="note">
  As one usecase example, this package enabled researchers to determine under which circumstances electromagnetic counterparts to gravitational wave events could be detectable by gamma-ray observatories, particularly in the TeV energy range. For more information about the original science motivation behind `sensipy`, check out the [ICRC 2023
