...
Gravitational wave toy supports time-resolved spectral models. 
...
<Aside>
    <p>
        CSV files are the current recommended format for gravitational wave toy spectral models due to their flexibility and ease of use.
    </p>
</Aside>
