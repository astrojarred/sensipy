...
sensipy also supports EBL models from Gammapy's dataset. To use them:
...
2. Download Gammapy datasets (includes EBL models):

   ```bash
   gammapy download datasets
   ```

3. Use any Gammapy-supported EBL model name when creating your source.
...
- Learn how to [calculate sensitivity curves](./sensitivity) with EBL-absorbed spectra
