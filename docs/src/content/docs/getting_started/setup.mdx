...
After installing sensipy, you'll need to set up the required data files to use the package effectively. This guide covers downloading and organizing Instrument Response Functions (IRFs), EBL models, and spectral model data.
...
- **prod5-v0.1** (Alpha Configuration, recommended for most use cases)
- **prod5-v0.2** (Alpha, Omega, and Alpha-LST configurations)
- **prod3b-v2** (Legacy support)

<Aside type="tip">
  The most recent Alpha configuration IRFs are **prod5-v0.1**, which can be
  found on [Zenodo](https://zenodo.org/records/5499840).
</Aside>
