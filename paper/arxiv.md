...
header-includes:
  - \AtBeginDocument{\author{Jarred G. Green\textsuperscript{1,2}, Barbara Patricelli\textsuperscript{3,4}, Antonio Stamerra\textsuperscript{4,5}, Monica Seglar-Arroyo\textsuperscript{6}\\[0.5em]\begin{center}\footnotesize\textsuperscript{1}~Max-Planck-Institut für Physik, Garching, Germany\\\textsuperscript{2}~Technische Universität München, Germany\\\textsuperscript{3}~University of Pisa, Italy\\\textsuperscript{4}~INAF - Osservatorio Astronomico di Roma, Italy\\\textsuperscript{5}~Cherenkov Telescope Array Observatory, Bologna, Italy\\\textsuperscript{6}~Institut de Fisica d'Altes Energies (IFAE), Barcelona, Spain\end{center}}}
